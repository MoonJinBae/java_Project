...
public class _02_정리 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 3. 조건문 : 조건식을 이용하여 참이면 실행문을 실핼(if, switch)
		 *  - if(조건식) {
		 *   실행문 ; }
		 *   else { 실행문 ; }
		 *   if (조건식) {
		 ...
		 *   
		 *  - switch(식 / 변수) {
		 *   // break;가 없으면 해당 케이스 이후 모든 케이스 실행
		 *   case 값1 : 실행문; break; 
		 *   case 값2 : 실행문; break;
		 *   case 값3 : 실행문; break;
		 *   ...
