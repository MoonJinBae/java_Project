...
public class _04_Operator4 {
    public static void main(String[] args) {
        ...
        System.out.println(김치찌개 || 계란말이 || 제육볶음); // 하나라도 true 이면 true - 단축키 || (or) : 괜찮은 식당
        System.out.println(김치찌개 && 계란말이 && 제육볶음); // 모두 true 이면 true - 단축키 && (and) : 최고의 식당
